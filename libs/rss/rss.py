...
class Rss:
    ...
    def search(self, query: str) -> List[Type[InlineQueryResult]]:
        best_p_t = process.extractBests(query,
                                        self.pengumuman_title_dict,
                                        score_cutoff=40,
                                        limit=3)
